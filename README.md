...
<title>Cultuur in Arnhem — Micha, Tijn, Justin L. — DH4A</title>
...
<header>
  <div>
    <div style="font-weight:800;font-size:18px">Micha, Tijn, Justin L. — DH4A</div>
    <div style="opacity:.9;font-size:13px">CKV — Cultuur in Arnhem • Professioneel & strak</div>
  </div>
  <div style="font-size:13px;opacity:.95">Doelgroep: Jongeren — Arnhem</div>
</header>

<div class="container">
  <div class="intro">
    <div>
      <strong style="font-size:15px">Ontdek Arnhem — interactieve kaart & draairad</strong>
    ...
    <div style="text-align:right;font-size:13px;color:var(--muted)">Gemaakt door Micha, Tijn, Justin L. — Klas DH4A</div>
  </div>
  ...
  <div class="grid">
    ...
    <div class="side">
      <div class="card wheel-wrap">
        <div style="font-weight:800">Draairad — Kies een plek</div>
        <canvas id="wheelCanvas" width="420" height="420"></canvas>
        <div style="display:flex;gap:10px">
          <button id="spinBtn" class="btn btn-spin">🎯 Draai het rad</button>
          <button id="randomBtn" class="btn" style="background:#eef2ff">Willekeurige</button>
        </div>
        <div id="spinResult" class="result">Draai het rad om een plek te kiezen — de kaart zoomt naar die plek.</div>
      </div>
      ...
      <div class="card">
        ...
        <div class="legend" style="margin-top:10px">
          ...
          <div class="legend-row"><div class="dot" style="background:#f59e0b"></div><div style="font-size:13px;color:var(--muted)">Clubs / Cafés / Foodhallen</div></div>
        </div>
...
<footer>Kaartdata: OpenStreetMap / Nominatim — geocoding live (kleine vertraging mogelijk). Controleer openingstijden op de websites.</footer>
...
const places = [
  ...
  {name:'Pathé Arnhem', addr:'Jansstraat 47, 6811 EK Arnhem', website:'https://www.pathe.nl/bioscopen/pathe-arnhem', cat:'youth', desc:'Bioscoop met de nieuwste films.'},
  ...
  {name:'Shooters', addr:'Korenmarkt 39, 6811 GW Arnhem', website:'https://www.facebook.com/shootersarnhem', cat:'bars', desc:'Danscafé en club voor jongeren.'},
  {name:'Bloopers', addr:'Pauwstraat 1, 6811 GK Arnhem', website:'https://bloopers-arnhem.nl', cat:'bars', desc:'Café/club met thema-avonden en DJ\'s.'},
  {name:'Suikerland', addr:'Drieslag 7, 6832 AM Arnhem', website:'NVT', cat:'bars', desc:'Gezellig lokaal café (kleine locatie).'},
  ...
  {name:'Café Arnhem Noord', addr:'Arnhem Noord', website:'https://www.facebook.com/p/Cafe-Arnhem-Noord-100057486308023/?locale=nl_NL', cat:'bars', desc:'Buurtcafé met lokale sfeer.'}
];
